                    ...
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="enterprise"
                                value="<?php echo htmlspecialchars($data["enterprise"]); ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="region"
                                value="<?php echo htmlspecialchars($data["region"]); ?>" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="sponsorship" required>
                                ...
                                <option value="其他" <?php if ($data["sponsorship"] == "其他")
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="hope" required>
                                ...
                                <option value="其他" <?php if ($data["hope"] == "其他")
                                    echo "selected"; ?>>其他</option>
                            </select>
                        </div>
