...
// 抓活動資料
$sql = "SELECT er.*, i.profile_img, i.enterprise, i.entype, i.enplace, i.enperson, i.enins, i.enphone, er.title, er.information, er.sponsorship, er.money, er.date, er.region, er.hope
      ...
      <div class="col-lg-3">
        <div class="card">
          <div class="card-body">
            ...
            <p style="font-size:16px;"><strong><?=($row['sponsorship']==='提供實習')?'實習地區':'活動地區'?>：</strong><?=$row['region']?></p>
      ...
      <div class="col-lg-6">
        ...
        <div class="card" id="comment-section">
          <div class="card-body">
            ...
            <button class="btn btn-primary btn-sm text-end" id="submit-comment" style="background-color:black; border:black;">送出</button>
      ...
      <div class="col-lg-3">
        <div class="card p-3">
          <div class="text-center mb-3">
            <img src="uploads/<?=$row['profile_img']?:'default-profile.png'?>" alt="頭像" class="rounded-circle" style="width:100px;height:100px;object-fit:cover;">
          </div>
          <p style="font-size:16px;"><strong>企業名稱：</strong><?=$row['enterprise']?></p>
          <p style="font-size:16px;"><strong>行業別：</strong><?=$row['entype']?></p>
          <p style="font-size:16px;"><strong>企業所在地區：</strong><?=$row['enplace']?></p>
          <p style="font-size:16px;"><strong>負責人：</strong><?=$row['enperson']?></p>
          <p style="font-size:16px;"><strong>社群連結：</strong><a href="<?=$row['enins']?>" target="_blank"><?=$row['enins']?></a></p>
          <p style="font-size:16px;"><strong>Email／電話：</strong><?=$row['enphone']?></p>
          <p style="font-size:16px;"><strong>合作偏好：</strong><?=$row['enprefer']?></p>
        </div>
      </div>
    </div>
  </div>
