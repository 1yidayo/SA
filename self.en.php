              ...
              <form id="contact-form" action="club_contact.php" method="post" enctype="multipart/form-data" style="width: 80%; margin-left: 0%;" >
                    ...
                    <div class="col-12">
                      <div class="input-group">
                        ...
                        <input class="form-control" type="text" placeholder="請輸入企業名稱(請輸入企業全名)" aria-label="請輸入企業全名"
                          name="school">
                      </div>
                      <div class="col-12">
                      <div class="input-group">
                        <div class="d-flex align-items-center bg-light text-body rounded-start p-2">
                          <span class="ms-1"><b>行業別</b></span>
                        </div>
                        <input class="form-control" type="text" placeholder="請輸入行業別" aria-label="請輸入行業別"
                          name="school">
                      </div>
                      <div class="col-12">
                      <div class="input-group">
                        ...
                        <input class="form-control" type="text" placeholder="請輸入統一編號" aria-label="請輸入統一編號"
                          name="school">
                      </div>
                      <div class="col-12">
                      <div class="input-group">
                        ...
                        <input class="form-control" type="text" placeholder="請輸入聯絡方式" aria-label="請輸入聯絡方式"
                          name="school">
                      </div>
                      <div class="col-lg-12">
                        <fieldset>
