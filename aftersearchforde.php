...
<body>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <form id="contact-form" action="aftersearchforde.php" method="post">
          <div class="row g-3">
            <!-- 預算範圍 -->
            <div class="col-6">
              ...
              <select class="form-select mt-2" aria-label="Default select example" name="money" id="money">
            ...
            <div class="col-6">
              ...
              <input class="form-control mt-2" type="text" placeholder="請輸入企業名稱" name="enterprise">
            </div>

            <!-- 搜尋按鈕 -->
            <div class="col-12 text-center mt-3">
              <button class="btn btn-light px-5 py-2" type="submit"><b>搜尋</b></button>
            </div>
          </div>
        </form>
      </div>
